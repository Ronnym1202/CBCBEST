    ...
    <head>
      ...
      <style>
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .url-table thead th:first-child { border-radius: 0; }
        .url-table tbody tr {
          border-bottom: 1px solid rgba(0,0,0,0.04);
          transition: background 0.15s;
        }
        .url-table tbody tr:last-child { border-bottom: none; }
        .url-table tbody tr:hover { background: rgba(201,160,61,0.04); }
        .url-table tbody tr:nth-child(even) { background: rgba(11,31,46,0.02); }
        .url-table tbody tr:nth-child(even):hover { background: rgba(201,160,61,0.04); }
        .url-table td {
          padding: 13px 16px;
          ...
          <table class="url-table">
            ...
            <tbody>
              <xsl:for-each select="sitemap:urlset/sitemap:url">
                ...
                <tr>
                  <td style="font-family:var(--mono); font-size:0.75rem; color:var(--muted); width:36px;">
        ...
        <div class="footer-inner">
          <div class="footer-top">
            <div class="footer-brand">
              ...
              <div style="margin-top:0.8rem; font-size:0.75rem; color:rgba(255,228,196,0.45);">
                Part of the Ronny Mwenda ecosystem:
                <a href="https://bestronny.netlify.app" style="color:rgba(201,160,61,0.8);">Bestronny</a> ·
                <a href="https://ronnymwenda.netlify.app" style="color:rgba(201,160,61,0.8);">RonnyMwenda</a> ·
                <a href="https://ronnygame.netlify.app" style="color:rgba(201,160,61,0.8);">RonnyGame</a>
              </div>
            </div>
